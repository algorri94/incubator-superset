...
HTTP_HEADERS = {'X-Frame-Options': 'ALLOW-FROM http://35.234.143.145:8501 www.ubika.es',
                'Content-Security-Policy': 'frame-ancestors http://35.234.143.145:8501 www.ubika.es'}
