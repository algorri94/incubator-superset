 ...
 */
export const fixDataTableBodyHeight = function ($tableDom, height, footerHeight) {
  ...
  $tableDom.find('.dataTables_scrollBody').css('max-height', height - headHeight - controlsHeight - paginationHeight - footerHeight);
};
